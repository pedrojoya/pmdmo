...
import es.iessaladillo.pedrojoya.cursogalileotareasemana1.modelos.Comentario;
...
public class ComentariosFragment extends Fragment {
    ...
    public void btnEnviarOnClick() {
        ...
        if (!TextUtils.isEmpty(texto)) {
            ...
            ParseObject comentario = new ParseObject(Comentario.TABLE_NAME);
            comentario.put(Comentario.FLD_TEXTO, texto);
            comentario.put(Comentario.FLD_PARENT, objectIdTienda);
    ...
    private void cargarLista() {
                ...
                new ParseQueryAdapter.QueryFactory<ParseObject>() {
                    public ParseQuery<ParseObject> create() {
                        ...
                        ParseQuery query = new ParseQuery<ParseObject>(
                                Comentario.TABLE_NAME);
                        query.setCachePolicy(ParseQuery.CachePolicy.CACHE_THEN_NETWORK);
                        query.whereEqualTo(Comentario.FLD_PARENT,
                                objectIdTienda);
                        return query;
                    }
                }) {
        ...
        adaptador.setTextKey(Comentario.FLD_TEXTO);
