...
import es.iessaladillo.pedrojoya.cursogalileotareasemana1.actividades.FotoActivity;
import es.iessaladillo.pedrojoya.cursogalileotareasemana1.actividades.MainActivity;
import es.iessaladillo.pedrojoya.cursogalileotareasemana1.adaptadores.FotosAdapter;
...
public class FotosListaFragment extends Fragment implements OnClickListener,
    ...
    public void fotoRecibida() {
        ...
        parseFileFoto.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                fotoParse = new ParseObject(Foto.TABLE_NAME);
                fotoParse.put(Foto.FLD_DESCRIPCION, descripcionFoto);
                fotoParse.put(Foto.FLD_ARCHIVO, parseFileFoto);
    ...
    private void cargarLista() {
        ...
        ParseQuery<ParseObject> query = new ParseQuery<ParseObject>(
                Foto.TABLE_NAME);
        query.setCachePolicy(ParseQuery.CachePolicy.CACHE_THEN_NETWORK);
        query.orderByDescending(Foto.FLD_DESCRIPCION);
