...
public class FotoInfoFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        query.whereEqualTo(Foto.FLD_OBJECTID, objectIdFoto);
    ...
    private void escribirVistas(Foto tienda) {
        ...
        // correspondientes.
        ParseFile file = parseFoto.getParseFile(Foto.FLD_ARCHIVO);
        Log.d("pedro", file.getUrl());
        imgFoto.setParseFile(parseFoto.getParseFile(Foto.FLD_ARCHIVO));
        ...
        parseFoto.refreshInBackground(new RefreshCallback() {
            public void done(ParseObject object, ParseException e) {
                if (e == null) {
                    ...
                    parseFoto = object;
                    parseFoto.put(Foto.FLD_FAVORITOS,
                            parseFoto.getLong(Foto.FLD_FAVORITOS) + 1);
