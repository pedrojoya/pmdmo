...
public class MainActivity extends Activity {
	...
	public View getView(final int posicion, View convertView, ViewGroup parent) {
	    ...
	    if (alumno.getEdad() < 18) {
	    	contenedor.lblNombre.setTextColor(getResources().getColor(R.color.rojo));
	    }
	    else {
	    	contenedor.lblNombre.setTextColor(getResources().getColor(R.color.negro));
	    }
//	    // Establezco el fondo de la vista-fila dependiendo de si dicho elemento está
//	    // seleccionado o no.
//	    if (lstAlumnos.isItemChecked(posicion)) {
//	    	fila.setBackgroundColor(getResources().getColor(R.color.seleccionado));
//	    }
//	    else {
//	    	fila.setBackgroundColor(getResources().getColor(R.color.desseleccionado));				
//	    }
//	    // Hago que el elemento cambie el estado de selección cuando se pulsa en la fila.
//	    fila.setOnClickListener(new OnClickListener() {
//			public void onClick(View v) {
//			    if (lstAlumnos.isItemChecked(posicion)) {
//					// Si ya estaba seleccionado lo desselecciono y cambio el fondo.
//					v.setBackgroundColor(getResources().getColor(R.color.desseleccionado));
//					lstAlumnos.setItemChecked(posicion, false);
//			    }
//			    else {
//					// Si no estaba seleccionado lo selecciono y cambio el fondo.
