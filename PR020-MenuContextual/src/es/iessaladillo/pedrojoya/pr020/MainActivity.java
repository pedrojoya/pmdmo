...
public class MainActivity extends Activity {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		if (v.getId() == R.id.lstAlumnos) {
			...
			menu.findItem(R.id.mnuEditar).setTitle(getString(R.string.editar) + lstAlumnos.getItemAtPosition(position));
			menu.findItem(R.id.mnuEliminar).setTitle(getString(R.string.eliminar) + lstAlumnos.getItemAtPosition(position));
		}
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.mnuEditar:
			mostrarTostada(getString(R.string.editar) + lstAlumnos.getItemAtPosition(position));
			break;
		case R.id.mnuEliminar:
			mostrarTostada(getString(R.string.eliminar) + lstAlumnos.getItemAtPosition(position));
			break;
		default:
