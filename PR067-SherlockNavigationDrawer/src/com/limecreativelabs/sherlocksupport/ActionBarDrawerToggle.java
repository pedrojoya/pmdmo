...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    private interface ActionBarDrawerToggleImpl {
        ...
        Object setActionBarUpIndicator(Object info,
                SherlockFragmentActivity activity, Drawable themeImage,
                int contentDescRes);

        Object setActionBarDescription(Object info,
     ...
     * <p/>
     * <p>
     * The given {@link android.app.Activity} will be linked to the specified
     * {@link android.support.v4.widget.DrawerLayout}. The provided drawer
     * indicator drawable will animate slightly off-screen as the drawer is
     * opened, indicating that in the open state the drawer will move off-screen
     * when pressed and in the closed state the drawer will move on-screen when
     * pressed.
     * </p>
     * <p/>
     * <p>
     ...
     * {@link android.app.Activity#onPostCreate(android.os.Bundle) onPostCreate}
     * method to synchronize after the DrawerLayout's instance state has been
     * restored, and any other time when the state may have diverged in such a
     * way that the ActionBarDrawerToggle was not notified. (For example, if you
    ...
    /**
     * {@link android.support.v4.widget.DrawerLayout.DrawerListener} callback
     * method. If you do not use your ActionBarDrawerToggle instance directly as
     * your DrawerLayout's listener, you should call through to this method from
     * your own listener object.
     * 
     * @param drawerView
