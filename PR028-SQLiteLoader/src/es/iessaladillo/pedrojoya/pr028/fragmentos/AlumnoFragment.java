...
public class AlumnoFragment extends Fragment {
    ...
    private void cargarAlumno(long id) {
        ...
        if (cursor.getCount() == 1) {
            ...
            alumno = DAO.cursorToAlumno(cursor);
        } else {
    ...
    private void agregarAlumno() {
        ...
        Uri resultado = this
                .getActivity()
                .getContentResolver()
                .insert(AlumnosContentProvider.URI_BASE,
                        DAO.alumnoToContentValues(alumno));
    ...
    private void actualizarAlumno() {
        ...
        Uri uri = Uri.parse(AlumnosContentProvider.URI_BASE + "/"
                + alumno.getId());
        if (this.getActivity().getContentResolver()
                .update(uri, DAO.alumnoToContentValues(alumno), null, null) > 0) {
            Toast.makeText(this.getActivity(),
