...
public class InstitutoContentProvider extends ContentProvider {
	...
	private static final String BASE_PATH_ALUMNOS = "alumnos";
	public static final Uri CONTENT_URI_ALUMNOS = Uri.withAppendedPath(
			CONTENT_URI_BASE, BASE_PATH_ALUMNOS);
	public static final String MIME_TYPE_ALUMNOS = ContentResolver.CURSOR_DIR_BASE_TYPE
			+ "/vnd.es.iessaladillo.instituto.alumnos";
	public static final String MIME_ITEM_TYPE_ALUMNOS = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/vnd.es.iessaladillo.instituto.alumno";

	// Constantes para tipos de Uris (deben tener todos un valor diferente).
	private static final int URI_TYPE_ALUMNOS_LIST = 10;
	private static final int URI_TYPE_ALUMNOS_ID = 20;
