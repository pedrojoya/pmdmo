...
import es.iessaladillo.pedrojoya.galileo.adaptadores.ImagenesInstagramAdapter;
import es.iessaladillo.pedrojoya.galileo.datos.ImagenInstagram;
import es.iessaladillo.pedrojoya.galileo.datos.Instagram;

public class InstagramListaFragment extends Fragment implements
        OnRefreshListener {
        ...
        Response.Listener<JSONObject> listenerRespuesta = new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject respuesta) {
                ...
                if (adaptador.getCount() > 0) {
                    rlListaFotosVacia.setVisibility(View.INVISIBLE);
                } else {
                    rlListaFotosVacia.setVisibility(View.VISIBLE);
                }
    ...
    private void parseRespuesta(JSONObject respuesta,
        ...
        try {
            ...
            for (int i = 0; i < dataKeyJSONArray.length(); i++) {
                ...
                if (elemento.getString(Instagram.TIPO_ELEMENTO_KEY)
                    ...
                    imagenInstagram.setUrl(imagen.getJSONObject(
                            Instagram.RESOLUCION_ESTANDAR_KEY)
    ...
    void cargarListaDesdeDB() {
        // Se consulta a la base de datos.
        // Si no hay registro se busca en Internet.
        cargarLista();
    }
}
