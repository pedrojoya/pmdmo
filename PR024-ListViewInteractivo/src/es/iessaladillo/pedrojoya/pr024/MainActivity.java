...
public class MainActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		albumes.add(new Album(R.drawable.mecanico, "Seré mecánico por ti", "1981", 2));
		albumes.add(new Album(R.drawable.cantecito, "Échate un cantecito", "1992", 4));
		albumes.add(new Album(R.drawable.carinio, "Está muy bien eso del cariño", "1995", 5));
		...
		albumes.add(new Album(R.drawable.ratito, "Un ratito de gloria", "2001", 3));
		albumes.add(new Album(R.drawable.hombre, "El hombre invisible", "2005", 3));
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		// Informo al usuario.
		mostrarTostada(album.getNombre() + " (" + album.getAnio() + ") - " + (int) album.getValoracion() + " estrellas");
	}
