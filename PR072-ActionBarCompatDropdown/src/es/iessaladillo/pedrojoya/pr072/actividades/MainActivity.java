package es.iessaladillo.pedrojoya.pr072.actividades;
...
import es.iessaladillo.pedrojoya.pr072.R;
import es.iessaladillo.pedrojoya.pr072.fragmentos.AlumnoFragment;
import es.iessaladillo.pedrojoya.pr072.fragmentos.NotasFragment;
...
public class MainActivity extends ActionBarActivity implements
    ...
    public boolean onNavigationItemSelected(int itemPosition, long itemId) {
        ...
        FragmentTransaction transaccion = getSupportFragmentManager()
                .beginTransaction();
        transaccion.replace(R.id.frlPrincipal, frg);
        transaccion.commit();
