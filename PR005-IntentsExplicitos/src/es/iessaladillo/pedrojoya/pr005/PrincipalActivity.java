...
public class PrincipalActivity extends Activity implements OnClickListener {
	...
	// Constantes.
	private static final int RC_ALUMNO = 1;	// Código de llamada a actividad Alumno.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        obtenerWidgets();
        // Hago que sea la propia actividad la que responda a los clicks sobre el botón.
	...
	private void solicitarDatos() {
		// Creo el intent para llamar explícitamente a la actividad de introducción de datos del alumno.
		// Utilizo el constructor que recibe paquete (this) y nombre de clase.
		Intent intencion = new Intent(this, AlumnoActivity.class);
		// Añado al intent los datos iniciales que se mostrarán en los TextView de la actividad.
		intencion.putExtra("nombre", nombre);
		intencion.putExtra("edad", edad);		
		// Inicio la actividad indicando que espero respuesta con un Request Code concreto.
	...
	private void mostrarDatos() {
		String sDatos = this.getString(R.string.nombre) + 
				": " + nombre + "\n" + 
				this.getString(R.string.edad) + 
