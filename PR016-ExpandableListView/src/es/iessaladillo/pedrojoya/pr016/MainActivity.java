...
public class MainActivity extends Activity implements OnChildClickListener {
    ...
    private class AdaptadorAlumnos extends BaseExpandableListAdapter {
        ...
        // Variables miembro.
        private ArrayList<String> mGrupos; // Nombres de los grupos.
        private ArrayList<ArrayList<Alumno>> mHijos; // Alumnos por grupo.
        private LayoutInflater mInflador;
        private int mColorMenorDeEdad;
        private int mColorMayorDeEdad;
        ...
        public AdaptadorAlumnos(Context contexto, ArrayList<String> grupos,
            ...
            mColorMenorDeEdad = recursos.getColor(R.color.menor_de_edad);
            mColorMayorDeEdad = recursos.getColor(R.color.mayor_de_edad);
        }
