...
/*		
		// Creo el array de datos.
		String[] albumes = new String[] {"Pepe", "Juan", "Antonio"};
		ArrayAdapter<String> adaptador = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, albumes);
...
/*		
		// Obtengo el valor del spinner.
		String album = (String) spnAlbumes.getSelectedItem();
		// Informo al usuario.
